...
require_once('conexion.php');
	...
	class CrudLibro{
		...
		public function insertar($libro){
			$db=Db::conectar();
			$insert=$db->prepare('INSERT INTO libros values(NULL,:nombre,:autor,:anio_edicion,:genero,:descripcion)');
		...
		public function actualizar($libro){
			$db=Db::conectar();
			$actualizar=$db->prepare('UPDATE libros SET nombre=:nombre, autor=:autor, anio_edicion=:anio, genero=:genero, descripcion=:descripcion  WHERE ID=:id');
